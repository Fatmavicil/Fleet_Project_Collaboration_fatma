...
//fatma
    ...
    public static List<WebElement> selectedNumbers(List<WebElement> selectedNumberList) {

        //List of all ACTUAL <options> as a integer
        List<WebElement> selectedNamesAsInteger = new ArrayList<>();

        for (WebElement each : selectedNumberList) {
            selectedNamesAsInteger.add(each);
        }
        return selectedNamesAsInteger;
    }
